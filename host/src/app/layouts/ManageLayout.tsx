...
const manageNavTree: ManageNavNode[] = [
  ...
  { id: 'task-center', label: '任务中心', icon: Activity, to: '/manage/task-center' },
  {
    ...
    children: [
      ...
      { id: 'media-yun139', label: '139 云盘凭据', icon: Database, to: '/manage/media/yun139' },
      { id: 'media-microsoft', label: '微软账号与 OAuth', icon: Cloud, to: '/manage/media/microsoft' },
      { id: 'media-pan115-share', label: '115 分享与同步', icon: Files, to: '/manage/media/pan115-share' },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'site-developer-api', label: '开放 API 目录', icon: Code, to: '/manage/media/developer-api' },
...
const PATH_PREFETCH_KEYS: Record<string, keyof typeof routeLoaders> = {
  ...
  '/manage/media/developer-api': 'manageDeveloperApi',
