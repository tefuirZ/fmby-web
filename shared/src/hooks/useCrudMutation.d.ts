 ...
 * ```
 */
export interface CrudMutationOptions<TVariables, TResult, TOnMutateResult = unknown> extends Omit<UseMutationOptions<TResult, Error, TVariables, TOnMutateResult>, 'mutationFn'> {
...
type CrudMutationKeyFactory<TResult, TVariables> = QueryKey[] | ((result: TResult, variables: TVariables) => QueryKey[]);
interface CrudMutationCacheContext<TResult, TVariables> {
    queryClient: QueryClient;
    result: TResult;
    variables: TVariables;
}
export declare function useCrudMutation<TVariables, TResult, TOnMutateResult = unknown>(options: CrudMutationOptions<TVariables, TResult, TOnMutateResult>): UseMutationResult<TResult, Error, TVariables, TOnMutateResult>;
export {};
//# sourceMappingURL=useCrudMutation.d.ts.map