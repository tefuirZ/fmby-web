 ...
 */
export type Pan115ImghostQrcodeStatus = 'waiting' | 'scanned' | 'signed' | 'expired' | 'canceled' | 'aborted' | 'unknown';
export type Pan115ImghostCredentialStatus = 'Active' | 'Pending' | 'Expired' | 'Unbound';
export type Pan115ImghostMirrorStatus = 'Uploading' | 'Ok' | 'Failed' | 'Unreachable' | 'Disabled';
