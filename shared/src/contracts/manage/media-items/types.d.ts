import type { ManageMountProviderType, ManageProbeTaskStreamRecord } from '../types';
export type ManageMediaItemMediaType = 'movie' | 'series' | 'season' | 'episode' | 'music' | 'music-album' | 'music-artist' | 'unknown';
export type ManageMediaItemSourceStatus = 'pending-validation' | 'playable' | 'unreachable' | 'unsupported' | 'auth-expired' | 'missing';
export type ManageMediaItemMountStatus = 'active' | 'unreachable' | 'disabled' | 'missing';
export type ManageMediaItemMetadataStatus = 'pending' | 'success' | 'failed' | 'missing';
export type ManageMediaItemMetadataSourceType = 'nfo' | 'manual' | 'scraped' | 'unknown';
