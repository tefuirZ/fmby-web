...
export type ManageUserRole = "user" | "restricted_user" | "admin" | "super_admin";
export type RegistrationCodeStatus = "active" | "paused" | "expired" | "used-up";
...
export type RuntimeLogLevel = "trace" | "debug" | "info" | "warn" | "error" | "unknown";
export type ManageLibraryType = "movie" | "series" | "music" | "mixed";
export type ManageMountProviderType = "local" | "webdav" | "s3-compatible" | "alist" | "openlist" | "pan115";
export type ManageScanStatus = "pending" | "running" | "completed" | "failed";
export type ManageScanTaskType = "full-scan" | "incremental-refresh" | "manual-refresh";
export type ManageProbeTaskStatus = "idle" | "queued" | "running" | "retry-waiting" | "succeeded" | "failed";
