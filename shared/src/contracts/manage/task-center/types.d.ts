export type TaskCenterCategory = 'Scan' | 'Identify' | 'Scrape' | 'AiAssist' | 'Review' | 'Tombstone';
export type TaskCenterStatus = 'Queued' | 'Running' | 'RetryWaiting' | 'Failed' | 'Succeeded' | 'NeedsReview' | 'Cancelled' | 'Skipped';
